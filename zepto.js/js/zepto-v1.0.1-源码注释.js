/**
 * 链接：http://www.cnblogs.com/sky000/archive/2013/03/29/2988952.html
 * Zepto是一个轻量级的针对现代高级浏览器的JavaScript库， 
 * 它与jquery有着类似的api。 如果你会用jquery，那么你也会用zepto。
 * 这段时间公司的事情比较少，所以就把它的源码看了下，觉得写的挺好的，
 * 所以就有了给它写注释的想法。
 * 当然，这里面的注释只是我读代码时对它的理解，并不一定正确，
 * 如果有错误还请指正，先谢谢了。另外，敬请期待另一个JS大牛（果果）的JS库(then.js)的源码注释。
 */
